...
function Steps() {
  return (
    <section classNameName="text-gray-600 body-font w-full">
      <div classNameName="container px-5 py-24 mx-auto">
        <div className="w-full flex justify-center">
          <h2 className="font-bold text-3xl ">Tips For Healthy Living</h2>
        </div>
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto flex flex-wrap">
            <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
              ...
              <div className="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-[#3B5FE8] text-white relative z-10 title-font font-medium text-sm">
                1
              </div>
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                <div className="flex-shrink-0 w-24 h-24 bg-indigo-100 text-[#3B5FE8] rounded-full inline-flex items-center justify-center">
                  <svg
                    fill="none"
                    stroke="currentColor"
